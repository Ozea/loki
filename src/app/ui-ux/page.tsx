  ...
  return (
    <main className="bg-white text-black pt-15 md:pt-40">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-start">
                <motion.div 
                  className="bg-[#171748] p-2 rounded-lg mr-4"
                  variants={iconVariants}
                >
      ...
      >
        <div className="container mx-auto px-4 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full items-center">
            ...
            <motion.div 
              className="order-2 col-span-2 flex justify-center lg:justify-end w-full"
      ...
      >
        ...
        >
          <motion.p 
            className="text-center max-w-4xl mx-auto mb-15 text-lg text-gray-600"
            variants={fadeInUpVariants}
          >
